...
//                finish();
                ...
                if(value == null && password!=null){
                    ...
                    switch (value){
                        ...
                        case 1: // 승인 완료
                            ...
                            User2 user = new User2(uid, name, allowCode, roomNumber);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            User2 user = new User2(mAuth.getCurrentUser().getUid(), null, -1, -99);
    ...
    private void signIn(final User2 user, String email, String password){ // sign in method
    ...
    private void inputInfoDialog(final String email, Integer roomNumber, String name){
        ...
        mDialog.findViewById(R.id.submit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                User2 user = new User2(getUid(), name, 0, mRoomNumber);
                mInputUserRefer = mDatabase.getReference();
    ...
    private void moveActivity(User2 user){
