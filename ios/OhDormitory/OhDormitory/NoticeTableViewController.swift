...
//    }
    ...
    override func viewDidLoad() {
        ...
        var request = URLRequest(url: URL(string: "https://dorm.emirim.kr/getNotice.php")!)
    ...
    func applySleepout(notice_id:Int,emirim_id:String,sleep_type:String){
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            //요청할 url
            var components = URLComponents(string: "https://dorm.emirim.kr/insertSleepoutRecordForJson.php")
            //요청변수
